...
@Component({
  selector: 'app-price-low',
  templateUrl: './price-low.component.html',
  styleUrls: ['./price-low.component.css']
})
export class PriceLowComponent implements OnInit{  
  ...
  constructor(private postsService: PostsService, private httpCilent: HttpClient, private fb: FormBuilder ) {
    this.retrieveAll();
