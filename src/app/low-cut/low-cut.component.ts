...
@Component({
  selector: 'app-low-cut',
  templateUrl: './low-cut.component.html',
  styleUrls: ['./low-cut.component.css']
})
export class LowCutComponent implements OnInit{  
  searchText: any;
  shoes: any=[];
  myForm: FormGroup;
  ...
  findLowCut(shoePart: any): any {
    return shoePart.cutting == 'low' ;
  }
}
