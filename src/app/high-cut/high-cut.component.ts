...
@Component({
  selector: 'app-high-cut',
  templateUrl: './high-cut.component.html',
  styleUrls: ['./high-cut.component.css']
})
export class HighCutComponent implements OnInit{  
  searchText: any;
  shoes: any=[];
  myForm: FormGroup;
  ...
  findHighCut(shoePart: any): any {
    return shoePart.cutting == 'high';
  }
}
