...
@Component({
  selector: 'app-mid-cut',
  templateUrl: './mid-cut.component.html',
  styleUrls: ['./mid-cut.component.css']
})
export class MidCutComponent implements OnInit{  
  searchText: any;
  shoes: any=[];
  myForm: FormGroup;
  ...
  findMidCut(shoePart: any): any {
    return shoePart.cutting == 'mid';
  }
}
